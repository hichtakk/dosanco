...
[![Build Status](https://github.com/hichtakk/dosanco/workflows/Build/badge.svg)](https://github.com/hichtakk/dosanco/actions?workflow=Build)
...
### Install CLI client
Download latest `dosanco` binary from [release](https://github.com/hichtakk/dosanco/releases) or you can build by yourself.

`$ go get -u github.com/hichtakk/dosanco/cli/dosanco`
