...
func initNetwork() {
	...
	if result := db.Take(&loopbackNetwork, "id=2"); result.Error != nil {
		loopbackNetwork.ID = 2
	...
	if result := db.Take(&linkLocalNetwork, "id=3"); result.Error != nil {
		linkLocalNetwork.ID = 3
	...
	if result := db.Take(&protoAssignNetwork, "id=4"); result.Error != nil {
		protoAssignNetwork.ID = 4
	...
	if result := db.Take(&testNetwork, "id=5"); result.Error != nil {
		testNetwork.ID = 5
	...
	if result := db.Take(&testNetwork2, "id=6"); result.Error != nil {
		testNetwork2.ID = 6
	...
	if result := db.Take(&testNetwork3, "id=7"); result.Error != nil {
		testNetwork3.ID = 7
